  ...
  return (
    <header className="p-4 flex justify-between md:px-8 lg:px-16">
      <div className="flex lg:my-auto">
        ...
        <h1 className="text-white ml-4 text-3xl mt-2">Solana.</h1>
      </div>
      <button
      ...
      >
        ...
        <ul className="my-auto lg:flex ">
          ...
          <li className="bg-button-color text-white text-sm w-20 text-center mx-auto mb-2 py-1 lg:bg-inherit lg:text-lg lg:w-auto lg:mr-60">
            <a href="/">Contact</a>
          </li>

        ...
        <div className=" mb-[7%] pb-[12%] md:pb-4 md:mb-3">
          <div className="flex pt-10 md:pt-3">
            ...
            <div className="w-full pt-2">
              ...
              <p className="mt-3 text-white w-[95%]">
                Just bought my first $SOL and I'm already loving the speed and
                low fees! Excited to be a part of the Solana community{" "}
                <span className="block mt-5">#Solana #Crypto</span>
              </p>
          ...
          <div className="flex pt-10">
            ...
            <div className="w-full pt-2">
              ...
              <p className="mt-3 text-white w-[95%]">
                Experience lightning-fast, low-cost payments with Solana Pay!
                💸⚡{" "}
                <span className="block mt-5 w-[10%]">
                  #SolanaPay #cryptopayments #fastandaffordable
                </span>

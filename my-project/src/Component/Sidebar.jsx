...
function Sidebar() {
  return (
    <div className="bg-[url(/images/wave.png)] bg-no-repeat px-10 py-[1%] h-[40%] md:w-[300px] md:h-auto md:bg-cover lg:w-[350px]">
      <div className="bg-sidebar-color backdrop-blur-md text-white my-[4%] px-10 rounded-md text-center md:my-[50%] md:text-left">
        <p className="text-base pt-5 pb-2 md:text-xl lg:text-2xl">
          ...
          <span className="text-dark-green">Solana.</span>
        </p>
